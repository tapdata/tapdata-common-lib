...
public class TapConstants {
    public final static List<JsonParser.AbstractClassDetector> abstractClassDetectors = Arrays.asList(
            ...
            JsonParser.AbstractClassDetector.create().key("typeName").value("TapFloat").deserializeClass(TapFloat.class),
            JsonParser.AbstractClassDetector.create().key("typeName").value("TapDouble").deserializeClass(TapDouble.class),
            JsonParser.AbstractClassDetector.create().key("typeName").value("TapCoefficientFloat").deserializeClass(TapCoefficientFloat.class),
            ...
            JsonParser.AbstractClassDetector.create().key("type").value(TapType.TYPE_INPUT_STREAM).deserializeClass(TapInputStream.class)
    );
