...
public interface StreamReadOneByOneFunction extends TapConnectorFunction {
    /**
     *
     ...
     */
    void streamRead(TapConnectorContext nodeContext, List<String> tableList, Object offsetState, StreamReadOneByOneConsumer consumer) throws Throwable;
}
