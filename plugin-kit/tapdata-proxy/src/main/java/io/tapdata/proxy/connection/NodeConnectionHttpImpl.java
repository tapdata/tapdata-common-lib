...
class ContentDataTest {
    ...
    @Test
    void testGetId() {
        contentData.setId("123");
        assertEquals("123", contentData.getId());
    }
    ...
    @Test
    void testGetContent() {
        contentData.setContent("Hello, World!");
        assertEquals("Hello, World!", contentData.getContent());
    }
    ...
    void testGetContentType() {
        contentData.setContentType("text/plain");
        assertEquals("text/plain", contentData.getContentType());
    }
    ...
    void testGetMetadata() {
        contentData.setMetadata("metadata");
        assertEquals("metadata", contentData.getMetadata());
    }
    ...
    void testGetCreatedAt() {
        contentData.setCreatedAt("2022-01-01T00:00:00Z");
        assertEquals("2022-01-01T00:00:00Z", contentData.getCreatedAt());
    }
    ...
    void testGetUpdatedAt() {
        contentData.setUpdatedAt("2022-01-01T00:00:00Z");
        assertEquals("2022-01-01T00:00:00Z", contentData.getUpdatedAt());
    }
